...
class CohortAnalyzer():
    def __init__(self, mod_enrol, student_program, coht1, coht2):
        ...
        self.ds_coht1 = mod_enrol[[int(x/100) == coht1 for x in mod_enrol.term] & [validate_student(student_program[student_program.student_token==x],coht1) for x in mod_enrol.student_token]]
        self.ds_coht2 = mod_enrol[[int(x/100) == coht2 for x in mod_enrol.term] & [validate_student(student_program[student_program.student_token==x],coht2) for x in mod_enrol.student_token]]
