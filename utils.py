...
class CohortAnalyzer():
    ...
    def PCAnalysis(self, n_components=5, n_iters=7, random_state=47, topkmods=10):
        ...
        fig = px.bar(mod_diff_svd_info.iloc[:topkmods,:], x='index', y='pc_diff',color='color',color_discrete_map={'red': 'red', 'blue': 'blue'}, hover_data={'color':False, 'mod_code':True, 'mod_faculty':True, 'grading_basis':True})
