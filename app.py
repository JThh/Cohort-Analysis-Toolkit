...
with st.beta_expander("Module enrolment difference analysis"):
  ...
  rand_stu_num_of_mod1, rand_stu_num_of_mod2, fig1, fig2 = analyzer.plot_random_student_selection_info(attr=attr_input)

  st.write('A random student from cohort',cohort1,'selected',rand_stu_num_of_mod1,'modules in year 1;','A random Student from cohort',cohort2,'selected',rand_stu_num_of_mod2,'modules in year 1')
